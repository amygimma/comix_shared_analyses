...
country_code_path <- c("uk", "nl", "be", "sc")[1]
...
panel_details <- c(NA, "cap_100", "trim_100", "trim_50", "ind_reported")[4]
...
nboots <- c(NA, "boots_10", "boots_100", "boots_250", "boots_500", "boots_1000")[2]
TEST <- FALSE
